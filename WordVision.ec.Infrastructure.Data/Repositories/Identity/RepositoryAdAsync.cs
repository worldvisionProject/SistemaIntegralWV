...
{
    public class RepositoryAdAsync<T> : IRepositoryAdAsync<T> where T : class
    {
        private readonly ActiveContext _dbContext;

        public RepositoryAdAsync(ActiveContext dbContext)
        {
