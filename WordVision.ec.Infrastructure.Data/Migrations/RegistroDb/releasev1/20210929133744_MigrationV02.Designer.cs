...
namespace WordVision.ec.Infrastructure.Data.Migrations.RegistroDb.releasev1
{
    ...
    [Migration("20210929133744_MigrationV02")]
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Planificacion.IndicadorCicloEstrategico", b =>
                {
                    ...
                    b.Property<int?>("IdIndicadorCiclo")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdIndicadorCiclo");

                    b.ToTable("IndicadorCicloEstrategico");
                });
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Planificacion.MetaCicloEstrategico", b =>
                {
                    ...
                    b.ToTable("MetaCicloEstrategico");
                });
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Soporte.Donante", b =>
                {
                    ...
                    b.Property<int>("TelefonoConvencional")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Soporte.Solicitud", b =>
                {
                    ...
                    b.Property<string>("AutorizacióndelLíderInmediato")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DescripciónProducto")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DisponibilidadPresupuestaria")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DocumentoBasedeTrabajo")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("FechaRequiereProducto")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("GuionMinuto_a_MinutoEvento")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("HoradelEvento")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("LogosSociosInvolucrados")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("NumSolicitud")
                        .HasColumnType("int");

                    b.Property<int>("NumdeTicketTI")
                        .HasColumnType("int");

                    b.Property<int>("NúmerodeParticipantesEstimado")
                        .HasColumnType("int");

                    b.Property<string>("ObjetivoProducto")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ObjetivodelEvento")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PersonalWVInvolucrado")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PersonasAutoridadesAsistirán")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PúblicoObjetivo")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SociosQuienesInteractuar")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("TransmisiónVirtual")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Planificacion.IndicadorCicloEstrategico", b =>
                {
                    b.HasOne("WordVision.ec.Domain.Entities.Planificacion.EstrategiaNacional", "EstrategiaNacionales")
                        ...
                        .HasForeignKey("IdIndicadorCiclo");
