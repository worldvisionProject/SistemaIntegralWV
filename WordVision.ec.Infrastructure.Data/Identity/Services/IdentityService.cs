...
using WordVision.ec.Application.Exceptions;
using WordVision.ec.Application.Interfaces;
using WordVision.ec.Application.Interfaces.Shared;
using WordVision.ec.DTOs.Identity;
using WordVision.ec.Infrastructure.Data.Identity.Models;

namespace WordVision.ec.Infrastructure.Data.Identity.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<ApplicationUser> userManager,
            ...
            SignInManager<ApplicationUser> signInManager, IEmailSender mailService)
        {
