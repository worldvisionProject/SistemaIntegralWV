...
using System.Text;
using WordVision.ec.Api.Services;
...
using WordVision.ec.Infrastructure.Data.Identity.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\WordVision.ec.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
