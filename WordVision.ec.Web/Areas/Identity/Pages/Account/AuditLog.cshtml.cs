...
using WordVision.ec.Application.DTOs;
using WordVision.ec.Application.Features.Logs.Queries.GetCurrentUserLogs;
using WordVision.ec.Application.Interfaces.Shared;
using WordVision.ec.Web.Abstractions;

namespace WordVision.Web.Areas.Identity.Pages.Account
{
